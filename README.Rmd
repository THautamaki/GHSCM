...
The method is described in the article *GHSCM: Efficient maximum a posteriori inference for gene co-expression networks with the graphical horseshoe prior*. All results can be reproduced using the codes from the separate GitHub repository at <https://github.com/THautamaki/GHSCM_results>.
