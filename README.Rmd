...
This R package implements a generalized expectation-maximization algorithm with a graphical horseshoe prior for network estimation and covariance and precision (inverse of the covariance) matrices estimation.
...
Plot the true simulated network and estimated network using R package `igraph`.
```{r, message = FALSE}
